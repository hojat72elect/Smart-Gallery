...
import ca.hojat.smart.gallery.shared.helpers.ALLOW_INSTANT_CHANGE
import ca.hojat.smart.gallery.shared.helpers.ALLOW_ONE_TO_ONE_ZOOM
import ca.hojat.smart.gallery.shared.helpers.ALLOW_PHOTO_GESTURES
import ca.hojat.smart.gallery.shared.helpers.ALLOW_ROTATING_WITH_GESTURES
import ca.hojat.smart.gallery.shared.helpers.ALLOW_VIDEO_GESTURES
import ca.hojat.smart.gallery.shared.helpers.ALLOW_ZOOMING_IMAGES
import ca.hojat.smart.gallery.shared.helpers.ANIMATE_GIFS
import ca.hojat.smart.gallery.shared.helpers.APP_ICON_COLOR
import ca.hojat.smart.gallery.shared.helpers.AUTOPLAY_VIDEOS
import ca.hojat.smart.gallery.shared.helpers.BACKGROUND_COLOR
import ca.hojat.smart.gallery.shared.helpers.BLACK_BACKGROUND
import ca.hojat.smart.gallery.shared.helpers.BOTTOM_ACTIONS
import ca.hojat.smart.gallery.shared.helpers.CROP_THUMBNAILS
import ca.hojat.smart.gallery.shared.helpers.DATE_FORMAT
import ca.hojat.smart.gallery.shared.helpers.DEFAULT_BOTTOM_ACTIONS
import ca.hojat.smart.gallery.shared.helpers.DELETE_EMPTY_FOLDERS
import ca.hojat.smart.gallery.shared.helpers.DIRECTORY_SORT_ORDER
import ca.hojat.smart.gallery.shared.helpers.DIR_COLUMN_CNT
import ca.hojat.smart.gallery.shared.helpers.DISPLAY_FILE_NAMES
import ca.hojat.smart.gallery.shared.helpers.EDITOR_BRUSH_COLOR
import ca.hojat.smart.gallery.shared.helpers.EDITOR_BRUSH_HARDNESS
import ca.hojat.smart.gallery.shared.helpers.EDITOR_BRUSH_SIZE
import ca.hojat.smart.gallery.shared.helpers.ENABLE_PULL_TO_REFRESH
import ca.hojat.smart.gallery.shared.helpers.EXCLUDED_FOLDERS
import ca.hojat.smart.gallery.shared.helpers.EXTENDED_DETAILS
import ca.hojat.smart.gallery.shared.helpers.FILE_LOADING_PRIORITY
import ca.hojat.smart.gallery.shared.helpers.FILE_ROUNDED_CORNERS
import ca.hojat.smart.gallery.shared.helpers.FILTER_MEDIA
import ca.hojat.smart.gallery.shared.helpers.FOLDER_MEDIA_COUNT
import ca.hojat.smart.gallery.shared.helpers.FOLDER_STYLE_SQUARE
import ca.hojat.smart.gallery.shared.helpers.FOLDER_THUMBNAIL_STYLE
import ca.hojat.smart.gallery.shared.helpers.GROUP_BY
import ca.hojat.smart.gallery.shared.helpers.GROUP_DIRECT_SUBFOLDERS
import ca.hojat.smart.gallery.shared.helpers.HIDE_EXTENDED_DETAILS
import ca.hojat.smart.gallery.shared.helpers.HIDE_SYSTEM_UI
import ca.hojat.smart.gallery.shared.helpers.INCLUDED_FOLDERS
import ca.hojat.smart.gallery.shared.helpers.IS_USING_SHARED_THEME
import ca.hojat.smart.gallery.shared.helpers.KEEP_LAST_MODIFIED
import ca.hojat.smart.gallery.shared.helpers.LAST_CONFLICT_APPLY_TO_ALL
import ca.hojat.smart.gallery.shared.helpers.LAST_CONFLICT_RESOLUTION
import ca.hojat.smart.gallery.shared.helpers.LAST_EDITOR_CROP_ASPECT_RATIO
import ca.hojat.smart.gallery.shared.helpers.LAST_EDITOR_CROP_OTHER_ASPECT_RATIO_X
import ca.hojat.smart.gallery.shared.helpers.LAST_EDITOR_CROP_OTHER_ASPECT_RATIO_Y
import ca.hojat.smart.gallery.shared.helpers.LIMIT_FOLDER_TITLE
import ca.hojat.smart.gallery.shared.helpers.LOOP_VIDEOS
import ca.hojat.smart.gallery.shared.helpers.MARK_FAVORITE_ITEMS
import ca.hojat.smart.gallery.shared.helpers.MAX_BRIGHTNESS
...
import ca.hojat.smart.gallery.shared.helpers.SCREEN_ROTATION
...
import ca.hojat.smart.gallery.shared.helpers.SHOW_NOTCH
import ca.hojat.smart.gallery.shared.helpers.SHOW_RECYCLE_BIN_AT_FOLDERS
import ca.hojat.smart.gallery.shared.helpers.SHOW_RECYCLE_BIN_LAST
import ca.hojat.smart.gallery.shared.helpers.SHOW_THUMBNAIL_FILE_TYPES
import ca.hojat.smart.gallery.shared.helpers.SHOW_THUMBNAIL_VIDEO_DURATION
import ca.hojat.smart.gallery.shared.helpers.SHOW_WIDGET_FOLDER_NAME
import ca.hojat.smart.gallery.shared.helpers.SKIP_DELETE_CONFIRMATION
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_INCLUDE_GIFS
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_INCLUDE_VIDEOS
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_INTERVAL
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_LOOP
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_MOVE_BACKWARDS
import ca.hojat.smart.gallery.shared.helpers.SLIDESHOW_RANDOM_ORDER
import ca.hojat.smart.gallery.shared.helpers.SORT_ORDER
import ca.hojat.smart.gallery.shared.helpers.TEXT_COLOR
import ca.hojat.smart.gallery.shared.helpers.THUMBNAIL_SPACING
import ca.hojat.smart.gallery.shared.helpers.USE_24_HOUR_FORMAT
import ca.hojat.smart.gallery.shared.helpers.USE_ENGLISH
import ca.hojat.smart.gallery.shared.helpers.USE_RECYCLE_BIN
import ca.hojat.smart.gallery.shared.helpers.VIEW_TYPE_FILES
import ca.hojat.smart.gallery.shared.helpers.VIEW_TYPE_FOLDERS
import ca.hojat.smart.gallery.shared.helpers.VISIBLE_BOTTOM_ACTIONS
import ca.hojat.smart.gallery.shared.helpers.WAS_USE_ENGLISH_TOGGLED
