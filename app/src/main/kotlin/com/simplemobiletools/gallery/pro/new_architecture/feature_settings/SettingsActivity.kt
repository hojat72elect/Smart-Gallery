...
import com.simplemobiletools.gallery.pro.new_architecture.shared.ui.dialogs.ChangeFileThumbnailStyleDialog
import com.simplemobiletools.gallery.pro.new_architecture.shared.ui.dialogs.ChangeFolderThumbnailStyleDialog
import com.simplemobiletools.gallery.pro.new_architecture.shared.ui.dialogs.ConfirmationDialog
import com.simplemobiletools.gallery.pro.new_architecture.shared.ui.dialogs.ExportFavoritesDialog
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.extensions.getProperSize
import com.simplemobiletools.gallery.pro.new_architecture.shared.extensions.handleExcludedFolderPasswordProtection
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.extensions.toBoolean
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.extensions.toStringSet
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ACCENT_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALBUM_COVERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_DOWN_GESTURE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_INSTANT_CHANGE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_ONE_TO_ONE_ZOOM
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_PHOTO_GESTURES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_ROTATING_WITH_GESTURES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_VIDEO_GESTURES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ALLOW_ZOOMING_IMAGES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ANIMATE_GIFS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.APP_ICON_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.AUTOPLAY_VIDEOS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.BACKGROUND_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.BLACK_BACKGROUND
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.BOTTOM_ACTIONS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.CROP_THUMBNAILS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DATE_FORMAT
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DEFAULT_BOTTOM_ACTIONS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DELETE_EMPTY_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DIRECTORY_SORT_ORDER
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DIR_COLUMN_CNT
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.DISPLAY_FILE_NAMES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.EDITOR_BRUSH_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.EDITOR_BRUSH_HARDNESS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.EDITOR_BRUSH_SIZE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ENABLE_PULL_TO_REFRESH
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.EXCLUDED_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.EXTENDED_DETAILS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FILE_LOADING_PRIORITY
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FILE_ROUNDED_CORNERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FILTER_MEDIA
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FOLDER_MEDIA_COUNT
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FOLDER_STYLE_SQUARE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.FOLDER_THUMBNAIL_STYLE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.GROUP_BY
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.GROUP_DIRECT_SUBFOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.HIDE_EXTENDED_DETAILS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.HIDE_SYSTEM_UI
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.INCLUDED_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.IS_USING_SHARED_THEME
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.KEEP_LAST_MODIFIED
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LAST_CONFLICT_APPLY_TO_ALL
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LAST_CONFLICT_RESOLUTION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LAST_EDITOR_CROP_ASPECT_RATIO
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LAST_EDITOR_CROP_OTHER_ASPECT_RATIO_X
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LAST_EDITOR_CROP_OTHER_ASPECT_RATIO_Y
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LIMIT_FOLDER_TITLE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.LOOP_VIDEOS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.MARK_FAVORITE_ITEMS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.MAX_BRIGHTNESS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.MEDIA_COLUMN_CNT
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.NavigationIcon
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.OPEN_VIDEOS_ON_SEPARATE_SCREEN
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PERMISSION_READ_STORAGE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PERMISSION_WRITE_STORAGE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PINNED_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PRIMARY_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PRIORITY_COMPROMISE
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PRIORITY_SPEED
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.PRIORITY_VALIDITY
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.REMEMBER_LAST_VIDEO_POSITION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ROTATE_BY_ASPECT_RATIO
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ROTATE_BY_DEVICE_ROTATION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.ROTATE_BY_SYSTEM_SETTING
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SCREEN_ROTATION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SCROLL_HORIZONTALLY
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SEARCH_ALL_FILES_BY_DEFAULT
...
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_EXTENDED_DETAILS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_HIDDEN_MEDIA
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_HIGHEST_QUALITY
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_NOTCH
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_RECYCLE_BIN_AT_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_RECYCLE_BIN_LAST
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_THUMBNAIL_FILE_TYPES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_THUMBNAIL_VIDEO_DURATION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SHOW_WIDGET_FOLDER_NAME
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SKIP_DELETE_CONFIRMATION
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_INCLUDE_GIFS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_INCLUDE_VIDEOS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_INTERVAL
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_LOOP
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_MOVE_BACKWARDS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SLIDESHOW_RANDOM_ORDER
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.SORT_ORDER
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.TEXT_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.THUMBNAIL_SPACING
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.USE_24_HOUR_FORMAT
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.USE_ENGLISH
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.USE_RECYCLE_BIN
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.VIEW_TYPE_FILES
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.VIEW_TYPE_FOLDERS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.VISIBLE_BOTTOM_ACTIONS
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.WAS_USE_ENGLISH_TOGGLED
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.WIDGET_BG_COLOR
import com.simplemobiletools.gallery.pro.new_architecture.shared.helpers.WIDGET_TEXT_COLOR
